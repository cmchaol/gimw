...
KERNELVER=4.8.17-hardened-r2-proxychains_grub_kernel_nouveau
...
time nice -10 \
tar -X /tmp/stage4.excl -c / | xz -9vT4  > /tmp/stage4_20170725_proxychains_grub_kernel_weston_nouveau.tar.xz
