...
| [2017-07-26 Wed 14:31]            | kernel configuration |      | [2017-07-24 Mon 14:14]   | make.conf | portage | service |
|-----------------------------------+----------------------+------+--------------------------+-----------+---------+---------|
| cp /etc/resolv.conf               |                      |      |                          |           |         |         |
|                                   |                      |      |                          |           |         |         |
| emerge proxychains                |                      |      |                          |           |         |         |
...
|                                   |                      |      |                          |           |         |         |
| f="/tmp/ker448-20170726-1500"     | Smallest Kernel      |      | f="/tmp/d-20170724-1425" |           |         |         |
|                                   |                      |      |                          |           |         |         |
| f="/tmp/ker448-20170726-1505"     | cpu tmpfs futex      |      | f="/tmp/d-20170724-1430" |           |         |         |
|                                   | eventpoll MULTIUSER  |      |                          |           |         |         |
|                                   |                      |      |                          |           |         |         |
| f="/tmp/ker448-20170726-1510"     | usb disk fs          |      | f="/tmp/d-20170724-1435" |           |         |         |
|                                   |                      |      |                          |           |         |         |
| f="/tmp/ker448-20170726-1515"     | netcards             |      | f="/tmp/d-20170724-1440" |           |         |         |
|-----------------------------------+----------------------+------+--------------------------+-----------+---------+---------|
| f="/tmp/ker448-20170726-1520"     | udev                 |      |                          |           |         |         |
|                                   |                      |      |                          |           |         |         |
| USE="udev"                        |                      |      | v                        | v         |         |         |
|                                   |                      |      |                          |           |         |         |
| emerge                            |                      |      |                          |           |         |         |
...
|-----------------------------------+----------------------+------+--------------------------+-----------+---------+---------|
| f="/tmp/ker448-20170726-1525"     | xorg driver          | x11  | f="/tmp/d-20170724-1450" |           |         |         |
|                                   |                      |      |                          |           |         |         |
| f="/tmp/ker448-20170726-1620"     | add Event interface  |      |                          |           |         |         |
|                                   |                      |      |                          |           |         |         |
...
KERNELVER=4.4.8-hardened-r1-nouveau
...
# add rootwait
sed -i 's/#GRUB_CMDLINE_LINUX_DEFAULT=""/GRUB_CMDLINE_LINUX_DEFAULT="rootwait nouveau.modeset=0"/' /etc/default/grub 
